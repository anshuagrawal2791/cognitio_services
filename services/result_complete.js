   ...
   [
   {
	...
	user.findOne({id:req.body.id},(err,user)=>{
		if(err)
			...
			// console.log("akldfldkjf"+(user.scores.ga*user.scores.plays));
			...
			// console.log(a1);
			// console.log(plays);
			// console.log(parseFloat(a1*plays));
			// console.log(parseFloat(a1*plays)+parseFloat(req.body.ga));
			// console.log(((a1*plays)+parseFloat(req.body.ga))/(plays+1));
			...
			user.scores.plays +=1;
			user.scores.total = user.scores.ga+user.scores.vr+user.scores.lr+user.scores.qa+user.scores.la+user.scores.sa+user.scores.ge+user.scores.m;
			// console.log(user);
			user.save((err)=>{
				if(err)
					console.log("---"+err);
